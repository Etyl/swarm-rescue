...
class MyDroneKeyboard(DroneAbstract):
    ...
    def control(self):
        ...
        with open("data/raw_measures.txt", "a") as f:
            f.write(f"{self.true_position()[0]} {self.true_position()[1]} {self.true_velocity()[0]} {self.true_velocity()[1]} {self.true_angle()} {self.true_angular_velocity()}\n")
